...
namespace Facturacion.Controllers
{
    public class Facturas1Controller : Controller
    {
        ...
        public Facturas1Controller(AplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["codigo_cliente"] = new SelectList(_context.clientes, "codigo_cliente", "codigo_cliente");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Numero_Factura,codigo_cliente,Fecha,Total,Anulada")] Factura factura)
        {
            ...
            ViewData["codigo_cliente"] = new SelectList(_context.clientes, "codigo_cliente", "codigo_cliente", factura.codigo_cliente);
            return View(factura);
        }
